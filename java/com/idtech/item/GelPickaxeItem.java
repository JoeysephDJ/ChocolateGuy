...
public class GelPickaxeItem extends PickaxeItem {
    ...
    public static Tier tier = new ForgeTier(4, 1561, 8.0F, 10.0F,
            3, null, ()->{return Ingredient.of(ItemMod.STRUCTURE_GEL);});
    public static Item INSTANCE = new GelPickaxeItem(tier, 50, 100,
            properties).setRegistryName(BaseMod.MODID, "gelpickaxe");
